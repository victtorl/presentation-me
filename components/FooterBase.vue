<template>
      ...
      <div class="w-full h-[80px] md:h-[65px] border-t border-blue-sass/10">
        <div class="relative h-full mx-auto theme-container">
          <div class="flex justify-center w-full">
            <img
              src="/assets/images/home-ten/copy-right-bg.png "
              alt=""
              class="absolute bottom-0 lighting-hue"
            />
          </div>
          <div class="flex flex-wrap items-center justify-between w-full h-full">
            ...
            <div class="relative flex justify-center w-full sm:w-fit">
              <a
                href="#"
                aria-label="go top"
                class="w-[40px] h-[40px] rounded-full border-[3px] flex justify-center items-center absolute -top-[75px] sm:-top-[55px]"
              >
                <span>
                  <svg
                    width="40"
